...
# Form implementation generated from reading ui file 'kmeans_dialog.ui'
#
...
class KMeans_Dialog(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(362, 295)
        self.groupBox_parameter = QtWidgets.QGroupBox(Dialog)
        self.groupBox_parameter.setGeometry(QtCore.QRect(10, 150, 161, 81))
        ...
        self.label_2.setGeometry(QtCore.QRect(10, 21, 61, 21))
        self.label_2.setObjectName("label_2")
        self.label_3 = QtWidgets.QLabel(self.groupBox_parameter)
        self.label_3.setGeometry(QtCore.QRect(10, 50, 72, 21))
        self.label_3.setObjectName("label_3")
        self.cluster_num = QtWidgets.QComboBox(self.groupBox_parameter)
        self.cluster_num.setGeometry(QtCore.QRect(100, 20, 51, 22))
        self.cluster_num.setEditable(True)
        self.cluster_num.setObjectName("cluster_num")
        self.cluster_num.addItem("")
        self.cluster_num.addItem("")
        self.cluster_num.addItem("")
        self.cluster_num.addItem("")
        self.cluster_num.addItem("")
        ...
        self.iter_num.setGeometry(QtCore.QRect(100, 50, 51, 22))
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "K-Means"))
        self.groupBox_parameter.setTitle(_translate("Dialog", "参数设置"))
        self.label_2.setText(_translate("Dialog", "聚类数："))
        self.label_3.setText(_translate("Dialog", "迭代次数："))
        self.cluster_num.setItemText(0, _translate("Dialog", "5"))
        self.cluster_num.setItemText(1, _translate("Dialog", "6"))
        self.cluster_num.setItemText(2, _translate("Dialog", "7"))
        self.cluster_num.setItemText(3, _translate("Dialog", "8"))
        self.cluster_num.setItemText(4, _translate("Dialog", "9"))
        self.cluster_num.setItemText(5, _translate("Dialog", "10"))
        self.cluster_num.setItemText(6, _translate("Dialog", "11"))
        self.cluster_num.setItemText(7, _translate("Dialog", "12"))
        self.cluster_num.setItemText(8, _translate("Dialog", "13"))
        self.cluster_num.setItemText(9, _translate("Dialog", "14"))
        self.cluster_num.setItemText(10, _translate("Dialog", "15"))
        self.iter_num.setItemText(0, _translate("Dialog", "10"))
        self.iter_num.setItemText(1, _translate("Dialog", "15"))
        self.iter_num.setItemText(2, _translate("Dialog", "20"))
        self.iter_num.setItemText(3, _translate("Dialog", "25"))
        self.iter_num.setItemText(4, _translate("Dialog", "30"))
        self.iter_num.setItemText(5, _translate("Dialog", "35"))
        self.iter_num.setItemText(6, _translate("Dialog", "40"))
        self.iter_num.setItemText(7, _translate("Dialog", "45"))
        self.iter_num.setItemText(8, _translate("Dialog", "50"))
