...
# Form implementation generated from reading ui file 'dbscan_dialog.ui'
#
...
class DBScan_Dialog(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(362, 295)
        self.groupBox_parameter = QtWidgets.QGroupBox(Dialog)
        self.groupBox_parameter.setGeometry(QtCore.QRect(10, 150, 201, 81))
        ...
        self.eps = QtWidgets.QComboBox(self.groupBox_parameter)
        self.eps.setGeometry(QtCore.QRect(120, 20, 71, 22))
        self.eps.setEditable(True)
        ...
        self.eps.addItem("")
        self.eps.addItem("")
        self.minPts = QtWidgets.QComboBox(self.groupBox_parameter)
        self.minPts.setGeometry(QtCore.QRect(120, 50, 71, 22))
        self.minPts.setEditable(True)
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "DBScan"))
        self.groupBox_parameter.setTitle(_translate("Dialog", "参数设置"))
        self.label_2.setText(_translate("Dialog", "扫描半径："))
        self.label_3.setText(_translate("Dialog", "最小包含点数："))
        self.eps.setItemText(0, _translate("Dialog", "10"))
        self.eps.setItemText(1, _translate("Dialog", "15"))
        self.eps.setItemText(2, _translate("Dialog", "20"))
        self.eps.setItemText(3, _translate("Dialog", "25"))
        self.eps.setItemText(4, _translate("Dialog", "30"))
        self.eps.setItemText(5, _translate("Dialog", "35"))
        self.eps.setItemText(6, _translate("Dialog", "40"))
        self.eps.setItemText(7, _translate("Dialog", "45"))
        self.eps.setItemText(8, _translate("Dialog", "50"))
        self.minPts.setItemText(0, _translate("Dialog", "10"))
        self.minPts.setItemText(1, _translate("Dialog", "20"))
        self.minPts.setItemText(2, _translate("Dialog", "30"))
        self.minPts.setItemText(3, _translate("Dialog", "40"))
        self.minPts.setItemText(4, _translate("Dialog", "50"))
        self.minPts.setItemText(5, _translate("Dialog", "60"))
        self.minPts.setItemText(6, _translate("Dialog", "70"))
        self.minPts.setItemText(7, _translate("Dialog", "80"))
        self.minPts.setItemText(8, _translate("Dialog", "90"))
        self.minPts.setItemText(9, _translate("Dialog", "100"))
